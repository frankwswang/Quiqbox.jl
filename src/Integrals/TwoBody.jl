...
basis set.
"""
eeInteractions(bs::AbstractVector{<:AbstractGTBasisFuncs{T, D}}) where {T, D} = 
getTwoBodyInts(∫eeInteractionCore, bs)

eeInteractions(bs::Tuple{Vararg{AbstractGTBasisFuncs{T, D}}}) where {T, D} = 
eeInteractions(bs|>collect)