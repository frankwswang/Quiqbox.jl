...
using Quiqbox: trySimplify, getOutputType, TypedBinary, StableBinary, PairCoupler, Storage, 
               BinaryReduce, Contract, TupleSplitHeader, GaussApproxInverse
...
#> `GaussApproxInverse`
gaussInv = GaussApproxInverse(Float64)
@test gaussInv(1.0) ≈ 1
@test gaussInv(3.0) ≈ inv(3.0)
@test gaussInv(37.0) ≈ inv(37.0)
@test gaussInv(100.0) ≈ inv(100.0)
